...
const Section = ({ section3 }: { section3: RefObject<HTMLDivElement> }) => {
  return (
    <div
      ref={section3}
      id="cm"
    ...
    >
      <div className="flex flex-col items-center justify-start px-4">
        <img src="/images/i/cartoon-finger.png" className="lg:w-64 sm:w-36" />
        <div className="flex flex-col text-center mx-auto align-middle bg-white py-8 px-4 rounded-xl border-zinc-400 drop-shadow-xl mt-4">
