...
const WebDevSectionDivider = ({ parentRef }) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Calculate the maximum translation to keep the SVG at the bottom of the parent element
      const maxTranslateY = parentHeight > window.innerHeight ? 0 : maxY;
  ...
  return (
    <div
      ...
      style={{
        transform: `translateY(${translateY - 300}px)`,
        transition:
